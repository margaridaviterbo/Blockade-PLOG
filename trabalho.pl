...
move(Board,[P1|P2],'NN',L1,NewBoard):-P1-2>0,NewPosX is P1-2,multiply(NewPosX,2,NewX),multiply(P2,2,NewY),getElementFromMatrix(Board,NewX,NewY,1,1,Value),Value\=r,Value\=e,replaceMatrix(Board,NewX,NewY,1,e,NewBoard),changePawn(NewPosX,P2,L1).
move(Board,[P1|P2],'N',L1,NewBoard):-P1-1>0,NewPosX is P1-1,multiply(NewPosX,2,NewX),multiply(P2,2,NewY),getElementFromMatrix(Board,NewX,NewY,1,1,Value),Value\=r,Value\=e,replaceMatrix(Board,NewX,NewY,1,e,NewBoard),changePawn(NewPosX,P2,L1).
move(Board,[P1|P2],'SS',L1,NewBoard):-P1+2>0,NewPosX is P1+2,multiply(NewPosX,2,NewX),multiply(P2,2,NewY),getElementFromMatrix(Board,NewX,NewY,1,1,Value),Value\=r,Value\=e,replaceMatrix(Board,NewX,NewY,1,e,NewBoard),changePawn(NewPosX,P2,L1).
move(Board,[P1|P2],'S',L1,NewBoard):-P1+1>0,NewPosX is P1+1,multiply(NewPosX,2,NewX),multiply(P2,2,NewY),getElementFromMatrix(Board,NewX,NewY,1,1,Value),Value\=r,Value\=e,replaceMatrix(Board,NewX,NewY,1,e,NewBoard),changePawn(NewPosX,P2,L1).
move(Board,[P1|P2],'OO',L1,NewBoard):-P2-2>0,NewPosY is P2-2,multiply(NewPosY,2,NewY),multiply(P1,2,NewX),getElementFromMatrix(Board,NewX,NewY,1,1,Value),Value\=r,Value\=e,replaceMatrix(Board,NewX,NewY,1,e,NewBoard),changePawn(P1,NewPosY,L1).
move(Board,[P1|P2],'O',L1,NewBoard):-P2-1>0,NewPosY is P2-1,multiply(NewPosY,2,NewY),multiply(P1,2,NewX),getElementFromMatrix(Board,NewX,NewY,1,1,Value),Value\=r,Value\=e,replaceMatrix(Board,NewX,NewY,1,e,NewBoard),changePawn(P1,NewPosY,L1).
move(Board,[P1|P2],'EE',L1,NewBoard):-P2+2>0,NewPosY is P2+2,multiply(NewPosY,2,NewY),multiply(P1,2,NewX),getElementFromMatrix(Board,NewX,NewY,1,1,Value),Value\=r,Value\=e,replaceMatrix(Board,NewX,NewY,1,e,NewBoard),changePawn(P1,NewPosY,L1).
move(Board,[P1|P2],'E',L1,NewBoard):-P2+1>0,NewPosY is P2+1,multiply(NewPosY,2,NewY),multiply(P1,2,NewX),getElementFromMatrix(Board,NewX,NewY,1,1,Value),Value\=r,Value\=e,replaceMatrix(Board,NewX,NewY,1,e,NewBoard),changePawn(P1,NewPosY,L1).
...
translate(e,[L3|L7],[L4|L8],[L5|L9],[L6|L10],X,Y,'Y').
translate(p,[L3|L7],[L4|L8],[L5|L9],[L6|L10],X,Y,'X'):-2*L3=:=X,2*L7=:=Y;2*L4=:=X,2*L8=:=Y.
translate(p,[L3|L7],[L4|L8],[L5|L9],[L6|L10],X,Y,'Y'):-2*L5=:=X,2*L9=:=Y;2*L6=:=X,2*L10=:=Y.
translate(p,[L3|L7],[L4|L8],[L5|L9],[L6|L10],X,Y,'o').
translate(j,[L3|L7],[L4|L8],[L5|L9],[L6|L10],X,Y,'X'):-2*L3=:=X,2*L7=:=Y;2*L4=:=X,2*L8=:=Y.
translate(j,[L3|L7],[L4|L8],[L5|L9],[L6|L10],X,Y,'Y'):-2*L5=:=X,2*L9=:=Y;2*L6=:=X,2*L10=:=Y.
translate(j,[L3|L7],[L4|L8],[L5|L9],[L6|L10],X,Y,'+').
