...
(PFinal=:=Value1,Mov is Value1-2,getPath(CalcPawn1,[11,4],Value1,[FinalX,FinalY],Mov),posToMov([Pawn1V,Pawn1H],[FinalX,FinalY],Result),move(Board,[Pawn1V,Pawn1H],Result,NewPawn,NewBoard,r),retract(pawn1(_)),assert(pawn1(NewPawn));
PFinal=:=Value2,Mov is Value2-2,getPath(CalcPawn1,[11,8],Value2,[FinalX,FinalY],Mov),posToMov([Pawn1V,Pawn1H],[FinalX,FinalY],Result),move(Board,[Pawn1V,Pawn1H],Result,NewPawn,NewBoard,r),retract(pawn1(_)),assert(pawn1(NewPawn));
PFinal=:=Value3,Mov is Value3-2,getPath(CalcPawn2,[11,4],Value3,[FinalX,FinalY],Mov),posToMov([Pawn2V,Pawn2H],[FinalX,FinalY],Result),move(Board,[Pawn2V,Pawn2H],Result,NewPawn,NewBoard,r),retract(pawn2(_)),assert(pawn2(NewPawn));
PFinal=:=Value4,Mov is Value4-2,getPath(CalcPawn2,[11,8],Value4,[FinalX,FinalY],Mov),posToMov([Pawn2V,Pawn2H],[FinalX,FinalY],Result),move(Board,[Pawn2V,Pawn2H],Result,NewPawn,NewBoard,r),retract(pawn2(_)),assert(pawn2(NewPawn)))
;
...
P1 is min(Value1,Value2),P2 is min(Value3,Value4),(PFinal is min(P1,P2),PFinal\=0;Value1==0,PFinal is Value4;Value2==0,PFinal is Value3;Value3==0,PFinal is Value2;Value4==0,PFinal is Value1),
(PFinal=:=Value1,Mov is Value1-2,getPath(CalcPawn1,[4,4],Value1,[FinalX,FinalY],Mov),posToMov([Pawn1V,Pawn1H],[FinalX,FinalY],Result),move(Board,[Pawn1V,Pawn1H],Result,NewPawn,NewBoard,e),retract(pawn3(_)),assert(pawn3(NewPawn));
PFinal=:=Value2,Mov is Value2-2,getPath(CalcPawn1,[4,8],Value2,[FinalX,FinalY],Mov),posToMov([Pawn1V,Pawn1H],[FinalX,FinalY],Result),move(Board,[Pawn1V,Pawn1H],Result,NewPawn,NewBoard,e),retract(pawn3(_)),assert(pawn3(NewPawn));
PFinal=:=Value3,Mov is Value3-2,getPath(CalcPawn2,[4,4],Value3,[FinalX,FinalY],Mov),posToMov([Pawn2V,Pawn2H],[FinalX,FinalY],Result),move(Board,[Pawn2V,Pawn2H],Result,NewPawn,NewBoard,e),retract(pawn4(_)),assert(pawn4(NewPawn));
PFinal=:=Value4,Mov is Value4-2,getPath(CalcPawn2,[4,8],Value4,[FinalX,FinalY],Mov),posToMov([Pawn2V,Pawn2H],[FinalX,FinalY],Result),move(Board,[Pawn2V,Pawn2H],Result,NewPawn,NewBoard,e),retract(pawn4(_)),assert(pawn4(NewPawn)))
).
...
checkPawnColision(Board,NewX,NewY):-%pawn1([Pawn1x,Pawn1y]),pawn2([Pawn2x,Pawn2y]),pawn3([Pawn3x,Pawn3y]),pawn4([Pawn4x,Pawn4y]),
%(NewX=\=2*Pawn3x-1;NewY=\=2*Pawn3y-1),(NewX=\=2*Pawn4x-1;NewY=\=2*Pawn4y-1),
getElementFromMatrix(Board,NewX,NewY,1,1,Value),Value\=r,Value\=e.%,(NewX=\=2*Pawn3x-1;NewY=\=2*Pawn3y-1),(NewX=\=(2*Pawn1x-1);NewY=\=(2*Pawn1y-1)),!.
...
canPassWalls(Board,[P1,P2],'NN'),NewPosX is P1-2,NewX is 2*NewPosX-1,NewY is 2*P2-1,checkPawnColision(Board,NewX,NewY),(\+ availableList(List),asserta(availableList(['NN']));availableList(List),\+ member('NN',List),retract(availableList(_)),append(['NN'],List,NewList),asserta(availableList(NewList))),fail;
canPassWalls(Board,[P1,P2],'N'),NewPosX is P1-1,NewX is 2*NewPosX-1,NewY is 2*P2-1,checkPawnColision(Board,NewX,NewY),(\+availableList(List),asserta(availableList(['N']));availableList(List),\+ member('N',List),retract(availableList(_)),append(['N'],List,NewList),asserta(availableList(NewList))),fail;
canPassWalls(Board,[P1,P2],'SS'),NewPosX is P1+2,NewX is 2*NewPosX-1,NewY is 2*P2-1,checkPawnColision(Board,NewX,NewY),(\+availableList(List),asserta(availableList(['SS']));availableList(List),\+ member('SS',List),retract(availableList(_)),append(['SS'],List,NewList),asserta(availableList(NewList))),fail;
canPassWalls(Board,[P1,P2],'S'),NewPosX is P1+1,NewX is 2*NewPosX-1,NewY is 2*P2-1,checkPawnColision(Board,NewX,NewY),(\+availableList(List),asserta(availableList(['S']));availableList(List),\+ member('S',List),retract(availableList(_)),append(['S'],List,NewList),asserta(availableList(NewList))),fail;
canPassWalls(Board,[P1,P2],'OO'),NewPosY is P2-2,NewX is 2*P1-1,NewY is 2*NewPosY-1,checkPawnColision(Board,NewX,NewY),(\+availableList(List),asserta(availableList(['OO']));availableList(List),\+ member('OO',List),retract(availableList(_)),append(['OO'],List,NewList),asserta(availableList(NewList))),fail;
canPassWalls(Board,[P1,P2],'O'),NewPosY is P2-1,NewX is 2*P1-1,NewY is 2*NewPosY-1,checkPawnColision(Board,NewX,NewY),(\+availableList(List),asserta(availableList(['O']));availableList(List),\+ member('O',List),retract(availableList(_)),append(['O'],List,NewList),asserta(availableList(NewList))),fail;
canPassWalls(Board,[P1,P2],'EE'),NewPosY is P2+2,NewX is 2*P1-1,NewY is 2*NewPosY-1,checkPawnColision(Board,NewX,NewY),(\+availableList(List),asserta(availableList(['EE']));availableList(List),\+ member('EE',List),retract(availableList(_)),append(['EE'],List,NewList),asserta(availableList(NewList))),fail;
canPassWalls(Board,[P1,P2],'E'),NewPosY is P2+1,NewX is 2*P1-1,NewY is 2*NewPosY-1,checkPawnColision(Board,NewX,NewY),(\+availableList(List),asserta(availableList(['E']));availableList(List),\+ member('E',List),retract(availableList(_)),append(['E'],List,NewList),asserta(availableList(NewList))),fail;
canPassWalls(Board,[P1,P2],'NO'),NewPosX is P1-1,NewX is 2*NewPosX-1,NewPosY is P2-1,NewY is 2*NewPosY-1,checkPawnColision(Board,NewX,NewY),(\+availableList(List),asserta(availableList(['NO']));availableList(List),\+ member('NO',List),retract(availableList(_)),append(['NO'],List,NewList),asserta(availableList(NewList))),fail;
canPassWalls(Board,[P1,P2],'NE'),NewPosX is P1-1,NewX is 2*NewPosX-1,NewPosY is P2+1,NewY is 2*NewPosY-1,checkPawnColision(Board,NewX,NewY),(\+availableList(List),asserta(availableList(['NE']));availableList(List),\+ member('NE',List),retract(availableList(_)),append(['NE'],List,NewList),asserta(availableList(NewList))),fail;
canPassWalls(Board,[P1,P2],'SE'),NewPosX is P1+1,NewX is 2*NewPosX-1,NewPosY is P2+1,NewY is 2*NewPosY-1,checkPawnColision(Board,NewX,NewY),(\+availableList(List),asserta(availableList(['SE']));availableList(List),\+ member('SE',List),retract(availableList(_)),append(['SE'],List,NewList),asserta(availableList(NewList))),fail;
